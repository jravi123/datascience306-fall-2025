...
subtitle: "Data exploration with ggplot"
output: 
  learnr::tutorial:
    progressive: true
    css: css/lecture.css
...
```{r}
mpg |> ggplot() + geom_point(aes(x = displ, y = hwy, color = factor(cyl))) + labs(title = 'Dipl vs hwy', color = 'cyl')
...
Scatter plots are great for graphing two **quantitative** or **continuous** variables.
