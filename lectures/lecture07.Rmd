...
But wait.. why not use the `mean` function?
...
Suppose we want to median center and scale in terms of the IQR. We are going to use this functionality on the original data, and also within years.
