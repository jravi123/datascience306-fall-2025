...
Here are examples of what XML, HTML, and JSON file structures look like.
...
**Note:** When you run the code in this exercise, the files will be created in a temporary directory used by the tutorial. They will not be saved to your project folder.

```{r saving-data, exercise = TRUE}
