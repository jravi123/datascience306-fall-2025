...
Detailed [Syllabus](https://umich.instructure.com/courses/781354/assignments/syllabus)
...
### To get the latest lecture notes/labs, you have to periodically execute a `git pull` to get the updates.

## Using our Posit Cloud

In this course, you may use Posit Cloud to run all lectures, homework and labs. 

Alternative environments include:

* <a href='https://colab.research.google.com/notebook#create=true&language=r' target = "_blank"> Colab </a>
...
$ git clone https://github.com/jravi123/datascience306-fall-2025
```
...
The [Shared Workspace](https://posit.cloud/spaces/678307/join?access_code=BJQmS98eb02wQyu83CFNehCFH6NTsCearUtQPNJd) already has the GitHub repo pulled in.  **This is read-only for you!**
...
To get lecture/lab updates after a copy is made, please run `git pull` on your copy.
...
* Blend **code** a.k.a.  **chunks** and **presentation**.
